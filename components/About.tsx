...
export default function About() {
  ...
  const topics = [
    'Narrative Design', 'Founder Psychology', 'Web3 Culture',
    'Brand Strategy', 'DeFi', 'DAOs', 'Belief Systems', 'NFTs',
  ]

  return (
    <section id="about" className="relative py-28 lg:py-36 bg-ink-soft overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <div className="space-y-5 text-cream-dim leading-[1.9] text-[0.95rem] font-light">
              ...
              <p>
                The podcast where no question is off-limits.
