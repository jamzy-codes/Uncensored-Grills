...
const episodes = [
  {
    ...
    description:
      "He markets like Hormozi. He thinks like Naval. Now he's on the hot seat. Leon Abboud goes deep on power dynamics, content monetization, and what most Web3 brands get dangerously wrong.",
    date: "Nov 19, 2025",
    duration: "57:41",
  ...
  },
  {
    ...
    description:
      "No scripts, no filters. Just real conversations about what it takes to build in Web3. Juan breaks down startup lessons, crypto culture, and why most content strategies are built on nothing.",
    date: "Dec 15, 2025",
    duration: "1:08:41",
  ...
  },
  {
    ...
    description:
      "Creators, founders, marketers. This one delivers. Kelano dissects how creators build strong brands, what companies should actually look for when hiring in Web3, and where NFTs still make sense today.",
    date: "Jan 15, 2026",
    duration: "1:11:46",
  ...
  },
  {
    ...
    guest: "Milad",
    title:
      "The Crypto Market Is Rigged | Low Float, High FDV & How Retail Gets Wrecked",
    description:
      "Most people think they're bad at crypto. Milad argues the system was designed for you to lose. Hard data from 5,600 crypto deals. An autopsy of the market, not hype or price prediction. Truth.",
    date: "Feb 6, 2026",
    duration: "1:08:41",
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1320px] mx-auto px-6 lg:px-14">
        ...
        <div
          ref={ref}
          className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-gold-line"
        >
          {episodes.map((ep, i) => (
    ...
    >
      <div className="relative w-full aspect-video overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-14 h-14 border-2 border-white/40 rounded-full flex items-center justify-center group-hover:border-gold group-hover:scale-110 transition-all duration-300">
            <span className="text-white/60 group-hover:text-gold text-[0.9rem] ml-1 transition-colors duration-300">
              ▶
            </span>
          </div>
        </div>
      ...
      <div className="p-7 border-t border-gold-line">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="font-mono text-[0.5rem] tracking-[0.1em] text-cream-ghost">
            {ep.date}
          </span>
        </div>
