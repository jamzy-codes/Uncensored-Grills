...
const episodes = [
  ...
  },
  {
    ...
    description: "Most people think they're bad at crypto. Milad argues the system was designed for you to lose. Hard data from 5,600 crypto deals. An autopsy of the market — not hype, not price prediction. Truth.",
    date: 'Feb 6, 2026',
    duration: '1:08:41',
