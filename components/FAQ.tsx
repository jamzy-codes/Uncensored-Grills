...
const faqs = [
  ...
  },
  {
    ...
    a: "Episodes don't follow a fixed schedule. A new episode drops when the right guest is ready, someone with something real to say. Quality over cadence. Subscribe on YouTube and join the newsletter to get notified the moment a new episode is live.",
  },
  {
    q: "Can I be a guest on the show?",
    a: "Yes. If you're a founder, builder, or leader with a real story to tell, apply using the form above. Dipo reviews every application personally. Come ready to go deep.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes, we're open to it. If that sounds like you, hit the Sponsor Us button and let's talk.",
  },
  {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.8fr] gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <p className="text-cream-dim text-[0.88rem] leading-[1.9] font-light max-w-xs">
              Can't find your answer here? Drop your question in the Ask section
              above. Dipo reads them all.
            </p>
          </div>

          {/* Right: accordion */}
          <div ref={ref} className={`reveal-right ${inView ? "visible" : ""}`}>
